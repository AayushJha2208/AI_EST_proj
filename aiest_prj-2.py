...
Original file is located at
    https://colab.research.google.com/drive/1Cpw17V6kTpJfq5mSsJbfE-eOpRw3crb5
...
print(f"Number of rows in truth_df: {truth_df.shape[0]}")

# For train_df
print("Number of rows per ID in train_df:")
display(train_df.groupby('id').size().head())
